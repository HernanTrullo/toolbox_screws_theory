...
po = np.array([0, 0, 0])
pk = np.array([0, 0, 0.155])
pr = np.array([0.425, 0, 0.155])
pf = np.array([0.820, 0.13, 0.155])
pg = np.array([0.82, 0.13, 0.053])
pp = np.array([0.82, 0.232, 0.053])
...
Hst0 = np.array([[-1, 0, 0, 0.838],[0,0,1, 0.364],[0,1, 0, 0.061],[0,0,0,1]])
...
# Tiempo de ejecución
tIK4 = round((time() - start_time)*1000, 1)
print(f"Time to solve IK Screw Theory: {tIK4} ms")
