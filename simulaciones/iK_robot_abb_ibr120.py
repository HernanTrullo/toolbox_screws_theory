...
Axis = np.column_stack((AxisZ, AxisY, AxisY, AxisX, AxisY, AxisX))
...
def ik_robot_puma(HstR, num_soluition = 0):
    Hst0 = np.array([[0, 0, -1, 0.462],[0,1,0,0],[1,0,0, 0.63],[0,0,0,1]])
    noap = HstR
