import numpy as np
from toolbox.pardos_gotor import pardos_gotor_four
...
Axis = np.array([[1, 0, 0], [1, 0, 0]]).transpose()   # Ejes de rotacion
Point = np.array([[0,0,0],[0,1,0]]).transpose()
...
Th1Th2 = pardos_gotor_four(Twist[:, 0], Twist[:, 1], pp, pk1)
